...
function UserMenu() {
  ...
  return (
    <div className="relative inline-flex">
      ...
      >
        <img className="w-8 h-8 rounded-full" src="https://i.pravatar.cc/32" width="32" height="32" alt="User" />
      ...
      <div
        className={`origin-top-right z-10 absolute top-full right-0 min-w-44 bg-white border border-gray-200 py-1.5 rounded shadow-lg overflow-hidden mt-1 ${!dropdownOpen ? 'hidden' : 'block' }`}
        ref={dropdown}
